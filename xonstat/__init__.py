...
def main(global_config, **settings):
    ...
    config.add_route("summary_stats_json_suffix", "/summary.json")
    config.add_view(summary_stats_json, route_name="summary_stats_json_suffix", renderer="json")
    ...
    config.add_view(player_game_index, route_name="player_game_index", accept="text/html",
                    renderer="player_game_index.mako")
    config.add_view(player_game_index_json, route_name="player_game_index",
                    accept="application/json", renderer="jsonp")
    ...
    config.add_view(player_info, route_name="player_info", accept="text/html",
                    renderer="player_info.mako")
    config.add_view(player_info_json, route_name="player_info", accept="application/json",
                    renderer="jsonp")
    ...
    config.add_view(player_hashkey_info_text, route_name="player_hashkey_info_text",
    ...
    config.add_view(game_info, route_name="game_info", accept="text/html",
                    renderer="game_info.mako")
    config.add_view(game_info_json, route_name="game_info", accept="application/json",
                    renderer="jsonp")
    ...
    config.add_route("server_top_maps_json", "/server/{id:\d+}/topmaps.json")
    config.add_view(view=ServerTopMaps, route_name="server_top_maps_json", attr="json",
                    renderer="json")
